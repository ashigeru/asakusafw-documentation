...
extlinks = {
    ...
    'apiref': ('http://docs.asakusafw.com/0.9.2/release/api/%s', None),
    'epub': ('http://docs.asakusafw.com/0.9.2/release/ja/epub/%s', None),
    'basic-tutorial': ('http://docs.asakusafw.com/basic-tutorial/0.9/release/ja/html/%s', None),
}
javadoclinks = {
    'asakusafw-javadoc': ('http://docs.asakusafw.com/0.9.2/release/api/%s.html', ""),
    'asakusa-gradle-groovydoc': ('http://docs.asakusafw.com/0.9.2/release/gradle-plugins/%s.html', ""),
    'asakusa-spark-gradle-groovydoc': ('http://docs.asakusafw.com/asakusa-on-spark/0.4.2/release/gradle-plugins/%s.html', ""),
    'asakusa-m3bp-gradle-groovydoc': ('http://docs.asakusafw.com/asakusa-on-m3bp/0.2.2/release/gradle-plugins/%s.html', ""),
}
