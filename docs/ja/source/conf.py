...
javadoclinks = {
    ...
    'asakusa-gradle-groovydoc': ('http://docs.asakusafw.com/0.9.0/release/gradle-plugins/%s.html', ""),
    'asakusa-spark-gradle-groovydoc': ('http://docs.asakusafw.com/asakusa-on-spark/0.4.0/release/gradle-plugins/%s.html', ""),
    'asakusa-m3bp-gradle-groovydoc': ('http://docs.asakusafw.com/asakusa-on-m3bp/0.2.0/release/gradle-plugins/%s.html', ""),
}
